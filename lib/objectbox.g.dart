...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
      ...
      name: 'Conversion',
      lastPropertyId: const obx_int.IdUid(5, 1729286742440811135),
      flags: 0,
  ...
  obx_int.ModelEntity(
      ...
      name: 'IngredientItem',
      lastPropertyId: const obx_int.IdUid(8, 6236051589328793269),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
        ...
        obx_int.ModelProperty(
            ...
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(7, 4179309004405117661),
            name: 'selectedFactorId',
            type: 6,
            flags: 0),
        obx_int.ModelProperty(
  ...
  obx_int.ModelEntity(
      ...
      name: 'Nutrient',
      lastPropertyId: const obx_int.IdUid(49, 6570446930734961847),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
  ...
  obx_int.ModelEntity(
      ...
      backlinks: <obx_int.ModelBacklink>[
        obx_int.ModelBacklink(
            name: 'ingredients', srcEntity: 'IngredientItem', srcField: 'step')
      ]),
  obx_int.ModelEntity(
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
      ...
      lastIndexId: const obx_int.IdUid(5, 3459184964907489599),
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    ...
    IngredientItem: obx_int.EntityDefinition<IngredientItem>(
        ...
        objectToFB: (IngredientItem object, fb.Builder fbb) {
          ...
          fbb.addInt64(6, object.selectedFactorId);
        ...
        objectFromFB: (obx.Store store, ByteData fbData) {
          ...
          final object = IngredientItem(
              ...
              shape: shapeParam,
              foodId: foodIdParam,
              selectedFactorId: selectedFactorIdParam);
...
class IngredientItem_ {
  ...
  /// See [IngredientItem.selectedFactorId].
  static final selectedFactorId =
      obx.QueryIntegerProperty<IngredientItem>(_entities[1].properties[6]);
