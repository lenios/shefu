...
final _entities = <obx_int.ModelEntity>[
  ...
  obx_int.ModelEntity(
    ...
    properties: <obx_int.ModelProperty>[
      ...
      obx_int.ModelProperty(
        id: const obx_int.IdUid(18, 4744556776444910403),
        name: 'videoUrl',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(20, 5777243446099130574),
        name: 'restTime',
        type: 6,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(21, 5174019013538193776),
        name: 'fat',
        type: 6,
        flags: 0,
      ),
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    ...
    Recipe: obx_int.EntityDefinition<Recipe>(
      ...
      objectToFB: (Recipe object, fb.Builder fbb) {
        ...
        fbb.addOffset(17, videoUrlOffset);
...
class Recipe_ {
  ...
  /// see [Recipe.variants]
  static final variants = obx.QueryBacklinkToMany<RecipeVariant, Recipe>(
    RecipeVariant_.recipe,
  );
}
...
class RecipeVariant_ {
  ...
  static final id = obx.QueryIntegerProperty<RecipeVariant>(
    _entities[6].properties[0],
  );

  /// See [RecipeVariant.title].
  static final title = obx.QueryStringProperty<RecipeVariant>(
    _entities[6].properties[1],
  );

  /// See [RecipeVariant.recipe].
  static final recipe = obx.QueryRelationToOne<RecipeVariant, Recipe>(
    _entities[6].properties[2],
  );

  /// see [RecipeVariant.steps]
  static final steps = obx.QueryBacklinkToMany<RecipeStep, RecipeVariant>(
    RecipeStep_.variant,
  );
}
