...
const _RecipecategoryEnumValueMap = {
  'all': 0,
  'snacks': 1,
  'cocktails': 2,
  'drinks': 3,
...
const _RecipecategoryValueEnumMap = {
  0: Category.all,
  1: Category.snacks,
  2: Category.cocktails,
  3: Category.drinks,
  4: Category.appetizers,
  5: Category.starters,
  6: Category.soups,
  7: Category.mains,
  8: Category.sides,
...
extension RecipeQueryFilter on QueryBuilder<Recipe, Recipe, QFilterCondition> {
  ...
  QueryBuilder<Recipe, Recipe, QAfterFilterCondition> countryCodeIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Recipe, Recipe, QAfterFilterCondition> countryCodeIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Recipe, Recipe, QAfterFilterCondition> countryCodeEqualTo(
    String? value, {
  ...
  QueryBuilder<Recipe, Recipe, QAfterFilterCondition> countryCodeGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Recipe, Recipe, QAfterFilterCondition> countryCodeLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Recipe, Recipe, QAfterFilterCondition> countryCodeBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Recipe, Recipe, QAfterFilterCondition> countryCodeStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Recipe, Recipe, QAfterFilterCondition> countryCodeEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension RecipeQuerySortBy on QueryBuilder<Recipe, Recipe, QSortBy> {
  ...
  QueryBuilder<Recipe, Recipe, QAfterSortBy> sortByCountryCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'countryCode', Sort.asc);
    });
  }

  QueryBuilder<Recipe, Recipe, QAfterSortBy> sortByCountryCodeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension RecipeQuerySortThenBy on QueryBuilder<Recipe, Recipe, QSortThenBy> {
  ...
  QueryBuilder<Recipe, Recipe, QAfterSortBy> thenByCountryCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'countryCode', Sort.asc);
    });
  }

  QueryBuilder<Recipe, Recipe, QAfterSortBy> thenByCountryCodeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'countryCode', Sort.desc);
    });
  }
...
extension RecipeQueryProperty on QueryBuilder<Recipe, Recipe, QQueryProperty> {
  ...
  QueryBuilder<Recipe, String?, QQueryOperations> countryCodeProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Recipe, String, QQueryOperations> sourceProperty() {
    return QueryBuilder.apply(this, (query) {
...
void _recipeStepSerialize(
  ...
  writer.writeObjectList<IngredientTuple>(
    offsets[1],
    allOffsets,
    IngredientTupleSchema.serialize,
    object.ingredients,
  );
  writer.writeString(offsets[2], object.instruction);
  writer.writeString(offsets[3], object.name);
  writer.writeLong(offsets[4], object.timer);
}
...
RecipeStep _recipeStepDeserialize(
  ...
  object.ingredients = reader.readObjectList<IngredientTuple>(
      ...
      [];
  object.instruction = reader.readString(offsets[2]);
  object.name = reader.readString(offsets[3]);
  object.timer = reader.readLong(offsets[4]);
  return object;
}
...
extension RecipeStepQueryFilter
  ...
  QueryBuilder<RecipeStep, RecipeStep, QAfterFilterCondition> imagePathLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<RecipeStep, RecipeStep, QAfterFilterCondition> imagePathBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<RecipeStep, RecipeStep, QAfterFilterCondition> imagePathEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<RecipeStep, RecipeStep, QAfterFilterCondition> nameEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<RecipeStep, RecipeStep, QAfterFilterCondition> nameGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<RecipeStep, RecipeStep, QAfterFilterCondition> nameLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<RecipeStep, RecipeStep, QAfterFilterCondition> nameBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<RecipeStep, RecipeStep, QAfterFilterCondition> nameStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<RecipeStep, RecipeStep, QAfterFilterCondition> nameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<RecipeStep, RecipeStep, QAfterFilterCondition> timerGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<RecipeStep, RecipeStep, QAfterFilterCondition> timerLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<RecipeStep, RecipeStep, QAfterFilterCondition> timerBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
const IngredientTupleSchema = Schema(
  ...
  deserialize: _ingredientTupleDeserialize,
  deserializeProp: _ingredientTupleDeserializeProp,
);

int _ingredientTupleEstimateSize(
  IngredientTuple object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
...
void _ingredientTupleSerialize(
  IngredientTuple object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
P _ingredientTupleDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension IngredientTupleQueryObject
    on QueryBuilder<IngredientTuple, IngredientTuple, QFilterCondition> {}
