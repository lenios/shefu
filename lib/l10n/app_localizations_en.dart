...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get pauseUsage => 'Tap to pause/resume,\nlong press to stop.';
  ...
  @override
  String get selectAllSites => 'All Sites';

  @override
  String get deselectAllSites => 'None';
  ...
  String postedOnBy(Object author, Object date) {
    return 'Posted on $date by $author';
  }

  @override
  String get exportRecipes => 'Export recipes';

  @override
  String get importRecipes => 'Import recipes';
  ...
  String importSkipped(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count duplicate recipes skipped',
      one: 'duplicate recipe skipped',
    );
    return '$_temp0';
  }
  ...
  @override
  String get importFromZip => 'Import from zip file';

  @override
  String get importFromUrl => 'Import from a web url';

  @override
  String get writeRecipe => 'Write recipe';
  ...
  String exportCount(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Export $count recipes',
      one: 'Export 1 recipe',
      zero: 'Export 0 recipe',
    );
    return '$_temp0';
  }
  ...
  @override
  String get invalidZipFile => 'Invalid file: the zip file is not a Shefu export archive.';
