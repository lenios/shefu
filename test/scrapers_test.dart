...
void main() {
  ...
  Map<String, (AbstractScraper Function(String, String), int)> scraperMap = {
    ...
    'budgetbytes.com': ((html, url) => AbstractScraper(html, url), 1), // fail groups on 2
    ...
    'lanascooking.com': ((html, url) => AbstractScraper(html, url), 1), // fail groups on 2
    'lecremedelacrumb.com': ((html, url) => AbstractScraper(html, url), 1),
    'marmiton.org': ((html, url) => MarmitonScraper(html, url), 2),
    'miljuschka.nl': ((html, url) => AbstractScraper(html, url), 1), // fail groups on 2
    ...
    'wellplated.com': ((html, url) => AbstractScraper(html, url), 1), // fail groups on 2
